...
namespace FreeCourse.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes => // Get properties!
            new ApiScope[]
            {
               new ApiScope("catalog_fullpermission","CatalogApiFullErisim"),
               new ApiScope("photo_stock_fullpermission","PhotoStockApiFullErisim"),
